  ...
  return (
    <section className='flex md:flex-row flex-col sm:py-16 py-6'>
        <div className='flex-1 flex justify-start items-start flex-col'>
            <h2 className='font-poppins font-semibold text-[30px] sm:text-[40px] text-white  leading-[40px] w-full'>
                Usted hace el negocio, nosotros manejamos el dinero.
            </h2>
            <p className='text-[#d8d8e4] font-poppins font-normal mt-10 sm:mt-0 text-[13px] sm:text-[18px] leading-[30.8px] text-justify'>
